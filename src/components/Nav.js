            ...
            <div className="w3-cell w3-cell-middle w3-container">
              {process.env.REACT_APP_CODEADAMCA ? (
                <>
                  <Link
                    to="/"
                    className="w3-text-white ca-pt-sans ca-margin-small-horizontal ca-font-none"
                  >
                    <img
                      src={codeBlockWhite}
                      className="ca-image-icon"
                      alt="Code Adam Logo"
                      width=""
                    />
                  </Link>
                ...
                <>
                  ...
                  <a
                    href="https://codeadam.ca/teaching.html"
                    className="w3-text-white ca-pt-sans ca-margin-small-horizontal ca-font-none"
                  >
                    Teaching
                  </a>
                  <span className="w3-text-white ca-pt-sans">|</span>
                  <a
                    href="https://codeadam.ca/research-publishings.html"
                    className="w3-text-white ca-pt-sans ca-margin-small-horizontal ca-font-none"
                  >
                    Research and Publishings
                  </a>
                  <span className="w3-text-white ca-pt-sans">|</span>
                  <a
                    href="https://codeadam.ca/speaking-engagements.html"
                    className="w3-text-white ca-pt-sans ca-margin-small-horizontal ca-font-none"
                  >
                    Speaking Engagements
                  </a>
                  <span className="w3-text-white ca-pt-sans">|</span>
                  <a
                    href="https://codeadam.ca/professional-development.html"
                    className="w3-text-white ca-pt-sans ca-margin-small-horizontal ca-font-none"
                  >
                    Professional Development
                  </a>
                  <span className="w3-text-white ca-pt-sans">|</span>
                  <a
                    href="https://codeadam.ca/about.html"
                    className="w3-text-white ca-pt-sans ca-margin-small-horizontal ca-font-none"
                  >
                    About Me
                  </a>
